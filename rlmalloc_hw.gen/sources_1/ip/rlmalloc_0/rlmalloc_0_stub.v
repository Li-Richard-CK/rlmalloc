...
//               c:/Users/liric/Research/rlmalloc/rlmalloc_hw.gen/sources_1/ip/rlmalloc_0/rlmalloc_0_stub.v
// Design      : rlmalloc_0
...
(* CHECK_LICENSE_TYPE = "rlmalloc_0,rlmalloc,{}" *) (* CORE_GENERATION_INFO = "rlmalloc_0,rlmalloc,{x_ipProduct=Vivado 2025.1,x_ipVendor=xilinx.com,x_ipLibrary=user,x_ipName=rlmalloc,x_ipVersion=1.0,x_ipCoreRevision=1,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,C_S_AXI_INTR_DATA_WIDTH=32,C_S_AXI_INTR_ADDR_WIDTH=5,C_NUM_OF_INTR=1,C_INTR_SENSITIVITY=0xFFFFFFFF,C_INTR_ACTIVE_STATE=0xFFFFFFFF,C_IRQ_SENSITIVITY=1,C_IRQ_ACTIVE_STATE=1,C_S00_AXI_DATA_WIDTH=32,C_S00_AXI_ADDR_WIDTH=5}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* X_CORE_INFO = "rlmalloc,Vivado 2025.1" *) 
module rlmalloc_0(s_axi_intr_awaddr, s_axi_intr_awprot, 

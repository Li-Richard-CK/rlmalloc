...
// Date        : Fri Dec 26 23:08:53 2025
// Host        : Richard running 64-bit major release  (build 9200)
// Command     : write_verilog -force -mode synth_stub -rename_top rlmalloc_axi_smc_1 -prefix
//               rlmalloc_axi_smc_1_ rlmalloc_axi_smc_1_stub.v
// Design      : rlmalloc_axi_smc_1
...
(* CHECK_LICENSE_TYPE = "rlmalloc_axi_smc_1,bd_aff6,{}" *) (* CORE_GENERATION_INFO = "rlmalloc_axi_smc_1,bd_aff6,{x_ipProduct=Vivado 2025.1,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=smartconnect,x_ipVersion=1.0,x_ipCoreRevision=27,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* X_CORE_INFO = "bd_aff6,Vivado 2025.1" *) 
module rlmalloc_axi_smc_1(aclk, aresetn, S00_AXI_awid, S00_AXI_awaddr, 
...
/* synthesis syn_force_seq_prim="aclk" */;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.aclk CLK" *) (* X_INTERFACE_MODE = "slave" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.aclk, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN rlmalloc_processing_system7_0_1_FCLK_CLK0, ASSOCIATED_BUSIF M00_AXI:M01_AXI:S00_AXI, INSERT_VIP 0, ASSOCIATED_CLKEN s_sc_aclken" *) input aclk /* synthesis syn_isclock = 1 */;

...
#
# Script generated by Vivado on Fri Dec 26 23:13:45 +0800 2025
# SW Build 6140274 on Thu May 22 00:12:29 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : rlmalloc.sh
...
#
# Usage        : rlmalloc.sh
#                rlmalloc.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                rlmalloc.sh [-reset_run]
#                rlmalloc.sh [-reset_log]
#                rlmalloc.sh [-help]
#
...
# script info
echo -e "rlmalloc.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./rlmalloc.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_21 -L processing_system7_vip_v1_0_23 -L axi_lite_ipif_v3_0_4 -L axi_intc_v4_1_21 -L xlconstant_v1_1_10 -L proc_sys_reset_v5_0_17 -L smartconnect_v1_0 -L axi_register_slice_v2_1_35 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot rlmalloc xil_defaultlib.rlmalloc xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim rlmalloc -key {Behavioral:sim_1:Functional:rlmalloc} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_aff6.protoinst" -protoinst "protoinst_files/rlmalloc.protoinst" -log simulate.log
}
...
map_local_libs()
{
  ...
  local_libs=(xil_defaultlib axi_infrastructure_v1_1_0 axi_vip_v1_1_21 processing_system7_vip_v1_0_23 axi_lite_ipif_v3_0_4 axi_intc_v4_1_21 xlconstant_v1_1_10 proc_sys_reset_v5_0_17 smartconnect_v1_0 axi_register_slice_v2_1_35)
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb rlmalloc.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./rlmalloc.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: rlmalloc.sh [-help]\n\
Usage: rlmalloc.sh [-step]\n\
Usage: rlmalloc.sh [-lib_map_path]\n\
Usage: rlmalloc.sh [-reset_run]\n\
Usage: rlmalloc.sh [-reset_log]\n\
Usage: rlmalloc.sh [-keep_index]\n\
Usage: rlmalloc.sh [-noclean_files]\n\n\

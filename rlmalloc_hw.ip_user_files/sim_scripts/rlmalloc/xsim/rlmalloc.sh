...
#
# Script generated by Vivado on Thu Dec 11 20:14:48 +0800 2025
...
simulate()
{
  xsim rlmalloc -key {Behavioral:sim_1:Functional:rlmalloc} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_6f37.protoinst" -protoinst "protoinst_files/rlmalloc.protoinst" -log simulate.log
}
